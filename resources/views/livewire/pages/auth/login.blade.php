...
<div>
    ...
    <form wire:submit="login" class="space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="form.email" id="email" class="block mt-1 w-full" type="email" name="email" placeholder="Enter your email" required autofocus autocomplete="username" />
        ...
        <div class="flex items-center justify-between">
            <label for="remember" class="inline-flex items-center">
                <input wire:model="form.remember" id="remember" type="checkbox" class="rounded border-gray-300 dark:border-borderColour-dark text-primary-600 shadow-sm focus:ring-primary-500 dark:bg-dark-100" name="remember">
