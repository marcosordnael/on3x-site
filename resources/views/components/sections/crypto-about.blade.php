  ...
  <div class="container relative z-10">
    <div class="grid grid-cols-2 max-md:grid-cols-1 gap-10 1xl:gap-x-24 items-center">
      <div class="relative flex max-md:justify-center justify-end items-center">
        ...
        />
        <img
          src="/images/about/aboutCrypto-dark.png"
          alt="crypto image"
        ...
        >
          <img
            src="/images/about/aboutCrypto-shape.png"
            alt="crypto image"
            class="dark:hidden"
          />
          <img
            src="/images/about/aboutCrypto-shape-dark.png"
            alt="crypto image"
      ...
      <div>
        ...
        <div class="tab-content">
          ...
          >
            <p class="max-md:mb-6 mb-8">
              Fuga perferendis, dolorem itaque asperiores similique qui hic distinctio beatae, sapiente eaque voluptatem
              optio voluptatibus quasi magni minima earum incidunt tempore eveniet exercitationem.
            </p>
            <ul class="[&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li class="flex items-center gap-x-2 ">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <g clip-path="url(#clip0_1045_9390)">
                      <path
                ...
                <span class="dark:text-white"> About the market. </span>
              </li>
              <li class="flex items-center gap-x-2">
                <span
                ...
                <span class="dark:text-white"> Educational content </span>
              </li>
              <li class="flex items-center gap-x-2 ">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                >
                  ...
                  >
                    <path
                      ...
                      class="fill-[#E6FFB1] dark:fill-[#3B3C39]"
                    />
                    <g clip-path="url(#clip0_1045_9400)">
                      <path
                ...
                <span class="dark:text-white"> Market analysis </span>
              </li>
            </ul>
          </div>
          <div
          ...
          >
            <p class="max-md:mb-6 mb-8">
              Officiis error suscipit fugit repellendus dolor odit ipsum quo nulla perspiciatis omnis. Facere eum minus
              sed. Perferendis impedit velit aperiam officia! Doloribus, accusantium fugit ex quas voluptate saepe iste
              magni.
            </p>
            <ul class="[&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li class="flex items-center gap-x-2 ">
                ...
                <span class="dark:text-white"> About the Blockchain market. </span>
              </li>
              <li class="flex items-center gap-x-2">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                ...
                <span class="dark:text-white"> Blockchain content </span>
              </li>
              <li class="flex items-center gap-x-2 ">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                ...
                <span class="dark:text-white"> Blockchain analysis </span>
              </li>
            </ul>
          </div>
          <div
          ...
          >
            <p class="max-md:mb-6 mb-8">
              Most cryptocurrencies are not controlled by any central authority such as a government or financial
              institution. Instead, they rely on decentralized networks where transactions are verified.
            </p>
            <ul class="[&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li class="flex items-center gap-x-2 ">
                <span
                ...
                <span class="dark:text-white"> About the privacy market. </span>
              </li>
              <li class="flex items-center gap-x-2">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                ...
                <span class="dark:text-white"> Privacy content </span>
              </li>
              <li class="flex items-center gap-x-2 ">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                ...
                <span class="dark:text-white"> Privacy analysis </span>
              </li>
            </ul>
          </div>
          <div
          ...
          >
            <p class="max-md:mb-6 mb-8">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellendus doloribus repellat commodi adipisci
              vitae unde rem suscipit minima odit recusandae. Et ducimus repellendus iste rerum nulla doloremque tempore
              accusamus nam?
            </p>
            <ul class="[&>*:not(:last-child)]:mb-6 max-md:[&>*:not(:last-child)]:mb-4">
              <li class="flex items-center gap-x-2 ">
                ...
                <span class="dark:text-white"> About the Exchanges. </span>
              </li>
              <li class="flex items-center gap-x-2">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                ...
                <span class="dark:text-white"> Exchange content </span>
              </li>
              <li class="flex items-center gap-x-2 ">
                <span
                  class=" relative  rounded-full bg-white dark:bg-dark-200 shadow-icon flex item-center justify-center"
                ...
                <span class="dark:text-white"> Exchange analysis </span>
              </li>
            </ul>
          </div>
        </div>
