    ...
    <div class="relative z-10">
      ...
      <div class="grid grid-cols-3 max-md:grid-cols-1 gap-8">
        <div class="group/image">
          <div class="bg-white dark:bg-dark-200 rounded-medium p-2.5 mb-6">
            <div class=" rounded bg-gray-100 dark:bg-[#30302F] overflow-hidden">
              <img src="/images/team/team1.png" alt="team member image" class="grayscale group-hover/image:grayscale-0 duration-300 transition-all">
            </div>
          </div>
          <div class="text-center">
            ...
            <ul class="flex items-center gap-x-2.5 justify-center">
              <li>
                <a href="#" class="group duration-500 transition-colors hover:transition-colors hover:duration-500">
                  <svg width="40" height="40" viewBox="0 0 40 40" fill="" xmlns="http://www.w3.org/2000/svg" class="fill-transparent group-hover:fill-primary  duration-500 group-hover:duration-500 transition-colors group-hover:transition-colors">
                    <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="#464745" class="stroke-gray-100 dark:stroke-[#464745] "></rect>
                    <path d="M28.75 20.0535C28.75 15.1914 24.8325 11.25 20 11.25C15.1675 11.25 11.25 15.1914 11.25 20.0535C11.25 24.4475 14.4497 28.0896 18.6328 28.75V22.5982H16.4111V20.0535H18.6328V18.114C18.6328 15.9076 19.9392 14.6889 21.9378 14.6889C22.8948 14.6889 23.8965 14.8608 23.8965 14.8608V17.0273H22.7932C21.7063 17.0273 21.3672 17.7059 21.3672 18.4028V20.0535H23.7939L23.406 22.5982H21.3672V28.75C25.5503 28.0896 28.75 24.4475 28.75 20.0535Z" fill="" class="fill-paragraph dark:fill-[#7D807B] dark:group-hover:fill-paragraph duration-500 group-hover:duration-500 transition-colors group-hover:transition-colors "></path>
                  </svg>
                </a>
              </li>
        ...
        <div class="group/image">
          <div class="bg-white dark:bg-dark-200 rounded-medium p-2.5 mb-6">
            <div class=" rounded bg-gray-100 dark:bg-[#30302F] overflow-hidden">
              <img src="/images/team/team2.png" alt="team member image" class="grayscale group-hover/image:grayscale-0 duration-300 transition-all">
            </div>
          </div>
          <div class="text-center">
        ...
        <div class="group/image">
          <div class="bg-white dark:bg-dark-200 rounded-medium p-2.5 mb-6">
            <div class=" rounded bg-gray-100 dark:bg-[#30302F] overflow-hidden">
              <img src="/images/team/team3.png" alt="team member image" class="grayscale group-hover/image:grayscale-0 duration-300 transition-all">
            </div>
          </div>
          <div class="text-center">
