<section id="services" class="pt-150 pb-150 relative">
  ...
  <div class="container relative">
    ...
    <div class="flex max-md:flex-col gap-8 items-center relative">
      <div
      ...
      <div
        class="max-md:w-full w-[32%]"
        data-aos="fade-right"
        data-aos-offset="200"
        data-aos-duration="1000"
        data-aos-once="true"
      >
        <div class="bg-white dark:bg-dark-200 rounded-medium p-2.5 shadow-nav mb-8">
          <div class="border border-dashed rounded border-gray-100 dark:border-borderColour-dark max-lg:p-5 p-10">
            <div class="bg-white dark:bg-dark-200 rounded-full max-lg:p-2 p-2.5 shadow-nav inline-block  mb-6">
              <div
              ...
              <div>
                <div class="relative size-[70px] shrink-0">
                  ...
                  <h3
                    ...
                    style="animation: 0.3s ease 1.5s 1 normal forwards running slide-up;"
                  >
                    <span>40</span>
                    %
                  </h3>
