<header class="fixed left-0 top-15 z-[1000000000] duration-500 transition-all w-full bg-transparent" id="mainnavigationBar">
  <nav class="container flex relative items-center">
    ...
    <ul class="nav-list hidden lg:flex lg:ml-7 xl:ml-15  [&amp;>*:not(:last-child)]:me-1">
      ...
      <li class="group">
        ...
        <div class="absolute grid gap-15 text-gray-900 dark:text-white md:grid-cols-12 w-full left-0 top-12 p-2.5  opacity-0 scale-y-0 origin-top duration-500 group-hover:scale-y-100 bg-white dark:bg-dark-200  group-hover:opacity-100 rounded-medium shadow-lg z-10 items-center">
    ...
    <div class="mobile-menu max-lg:overflow-y-auto">
      ...
      <ul class="nav-list flex flex-col gap-5 w-full max-w-[500px] landscape:h-full relative">
        <li class="relative group faq-item">
          <p class="faq-header font-Inter flex items-center text-base font-medium leading-8 text-paragraph dark:text-white py-[5px] px-5 lg:px-4 xl:px-5 border rounded-large border-transparent hover:bg-white hover:border-borderColour dark:hover:bg-dark-200 
            dark:hover:border-borderColour/10 duration-500 hover:duration-500 transition-colors group ">
            Home
            <i class="fa-solid fa-angle-down text-paragraph dark:text-white ml-auto group-[.open]:rotate-180 duration-500 mt-1"></i>
          </p>
        ...
        <li class="relative group faq-item">
          ...
          <div class="absolute text-gray-900 dark:text-white w-full left-0 top-12 p-5  opacity-0 scale-y-0 origin-top duration-500 group-hover:scale-y-100 bg-white dark:bg-dark-200  group-hover:opacity-100 rounded-medium shadow-lg z-10 items-center faq-body close">
        ...
        <li class="relative group faq-item">
          <p href="javascript:void(0)" class="faq-header font-Inter flex items-center text-base font-medium leading-8 text-paragraph dark:text-white py-[5px] px-5 lg:px-4 xl:px-5 border rounded-large border-transparent hover:bg-white hover:border-borderColour dark:hover:bg-dark-200 dark:hover:border-borderColour/10 duration-500 hover:duration-500 transition-colors group ">
            News
            <i class="fa-solid fa-angle-down text-paragraph dark:text-white ml-auto group-[.open]:rotate-180 duration-500 mt-1"></i>
          </p>
          <ul class="absolute w-full min-w-[250px] left-0 top-12  p-5   opacity-0 scale-y-0 origin-top duration-500 group-hover:scale-y-100 bg-white dark:bg-dark-200  group-hover:opacity-100 rounded-md [&amp;>*:not(:last-child)]:border-b [&amp;>*:not(:last-child)]:border-dashed [&amp;>*:not(:last-child)]:border-borderColour dark:[&amp;>*:not(:last-child)]:border-borderColour-dark [&amp;>*:not(:first-child)]:mt-2.5 z-10 faq-body close">
