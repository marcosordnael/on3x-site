{{-- Footer Section --}}
<section class="bg-white dark:bg-dark-300 overflow-hidden relative max-md:pt-20 pt-150">
  <div class="container relative z-10">
    ...
    <div class="grid grid-cols-12 mb-20 max-lg:gap-y-10 max-md:text-center">
      <div class="col-span-12 md:col-span-6 lg:col-span-2 max-md:text-center">
      ...
      <div class="col-span-12 md:col-span-6 lg:col-span-6">
        <div class="1xl:pl-150">
          <h3 class="mb-8 font-medium text-lg">Newsletter</h3>
          <form>
    ...
    <div class="py-10 max-lg:text-center">
      <div class="flex max-lg:flex-col lg:items-center">
        <p class="max-lg:mb-10">@ <span id="date">2025</span> Aplio. All Rights Reserved</p>
